...
vuln_map_wrong
```
We can tell this is wrong because there are negative vulnerability scores. 
...
We will then compare it to the original Malcomb (2014) study's Figure 5.
...
Then we calculatde new unique second level ID's as 1000 times the row numbe and removed splinter polygons by selecting polygons over 4 km\^2 with centroids intersecting livelihood zones.
...
Especially when the lives and livelihoods of those living in Malawi may be seriously affected by the construction of Malcomb et als (2014) social vulnerability model, reproducibility would have been a sign of transparency and clarity.
The failure to reproduce Figures 4 and 5, despite multiple error corrections, suggests that Malcomb et al (2014) may need to improve on their transparency pertaining to how they transformed their metadata to create their figures.
The increased transparency in this study as well as other studies can help to improve reproduction.
